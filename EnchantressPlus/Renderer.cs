...
namespace EnchantressPlus
{
    internal class Renderer
    {
        ...
        public Renderer(Config config)
        {
            ...
            config.Menu.CalculationItem.PropertyChanged += TextChanged;

            if (config.Menu.CalculationItem)
            {
        ...
        public void Dispose()
        {
            ...
            Menu.CalculationItem.PropertyChanged -= TextChanged;
        }
        ...
        private void OnDraw(EventArgs args)
        {
            ...
            foreach (var Data in Config.DamageCalculation.DamageList)
            {
                ...
                var hp = Math.Ceiling((float)health / hero.MaximumHealth * 100);
                ...
                if (!hero.IsVisible)
                {
                    ...
                    Texture(pos, new Vector2(65), $"other/round_percentage/hp/{ Math.Min(hp, 100) }");
